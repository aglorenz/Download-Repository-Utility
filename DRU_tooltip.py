...
class TooltipBase:
    ...
    def showtip(self):
        """display the tooltip"""
        if self.tipwindow or self.text is None:
            return
...
class OnHoverTooltipBase(TooltipBase):
    ...
    def __init__(self, anchor_widget, hover_delay=1000,
                 widget_fn_in=None, widget_fn_out=None):
        ...
        self.widget_fn_in = widget_fn_in
        self.widget_fn_out = widget_fn_out
    ...
    def _show_event(self, event=None):
        ...
        if self.widget_fn_in:    # call optional function
            self.widget_fn_in()
        if self.hover_delay:
            self.schedule()
        else:
    ...
    def _hide_event(self, event=None):
        ...
        if self.widget_fn_out:    # call optional function to affect any widget
            self.widget_fn_out()
        self.hidetip()
...
class Hovertip(OnHoverTooltipBase):
    ...
    def __init__(self, anchor_widget, text, hover_delay=1000,
        ...
        super(Hovertip, self).__init__(anchor_widget, hover_delay=hover_delay,
                                       widget_fn_in=widget_fn_in,
                                       widget_fn_out=widget_fn_out)
        self.text = text
